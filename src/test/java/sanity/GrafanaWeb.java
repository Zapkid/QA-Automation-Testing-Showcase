...
public class GrafanaWeb extends CommonOps {
    ...
    public void Test02_ViewUsers() {
        UIActions.mouseHover(grafanaLeftMenu.getBtn_serverAdmin(), grafanaServerAdminMini.getBtn_users());
        // users_tableRows counts the Header as the 1st row (intentionally)
        Verifications.numberOfElements(grafanaUsersPage.getUsers_tableRowsWithHeader(), 2);
    }
    ...
    public void Test03_CreateNewUser() {
        ...
        // users_tableRows counts the Header as the 1st row (intentionally)
        Verifications.numberOfElements(grafanaUsersPage.getUsers_tableRowsWithHeader(), 3);
    }
    ...
    public void Test05_VerifyToolbar() {
        Verifications.visibilityOfElements(grafanaMain.getToolbarButtons());
    }
