...
public class GrafanaAPI extends CommonOps {
    ...
    public void test01_verifyTeam() {
        Verifications.verifyString(ApiFlows.getTeamProperty("teams[0].name"), "Kuku Group");
    }
    ...
    public void test02_addTeamAndVerify() {
        ...
        Verifications.verifyString(ApiFlows.getTeamProperty("teams[1].name"), "YoniTeam");
    }
    ...
    public void test03_updateTeamAndVerify() {
        ...
        Verifications.verifyString(ApiFlows.getTeamProperty("teams[1].email"), "yoni@atidcollege.co.il");
    }
    ...
    public void test04_deleteTeamAndVerify() {
        ...
        Verifications.verifyString(ApiFlows.getTeamProperty("totalCount"), "1");
    }
}
